			...
			public void onClick(View v) {
				...
				suiv.setOnClickListener(new View.OnClickListener() {
					...
					public void onClick(View v) {
						...
						if (no == 1) {
							AlertDialog.Builder alertDialog = new AlertDialog.Builder(jeux4.this);
							...
							alertDialog.setPositiveButton("No", new DialogInterface.OnClickListener() {
								...
								public void onClick(DialogInterface dialog, int which) {
									Intent secondeActivite = new Intent(jeux4.this, menu2.class);
									startActivity(secondeActivite);
									jeux4.this.finish();
								}
							});
							alertDialog.setNegativeButton("Yes", new DialogInterface.OnClickListener() {
								@Override
								public void onClick(DialogInterface dialog, int which) {
									Intent secondeActivite = new Intent(jeux4.this, jeux4.class);
									int reco = 1;
