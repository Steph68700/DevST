		...
		suiv.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
            	if(compt<=0){
					...
					if (no == 1) {
						AlertDialog.Builder alertDialog = new AlertDialog.Builder(jeux5.this);
						alertDialog.setTitle("Votre chance a ce jeux : " + y);
						alertDialog.setCancelable(false);
						alertDialog.setMessage("Recommencer ?");
						alertDialog.setPositiveButton("No", new DialogInterface.OnClickListener() {
							@Override
							public void onClick(DialogInterface dialog, int which) {
								Intent secondeActivite = new Intent(jeux5.this, menu2.class);
								startActivity(secondeActivite);
								jeux5.this.finish();
							}
						});
						alertDialog.setNegativeButton("Yes", new DialogInterface.OnClickListener() {
							@Override
							public void onClick(DialogInterface dialog, int which) {
								Intent secondeActivite = new Intent(jeux5.this, jeux5.class);
								int reco = 1;
